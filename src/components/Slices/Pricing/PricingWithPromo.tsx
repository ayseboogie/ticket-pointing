...
import { SwirlyDoodle } from "@/components/SwirlyDoodle.tsx";
                ...
                >
                  <div className="lg:min-w-0 lg:flex-1">
                    <PrismicRichText
                      ...
                      components={{
                        heading3: ({ children }) => (
                          <h3 className="text-lg font-semibold leading-8 tracking-tight text-darkGrey">
                            {children}
                          </h3>
                        ),
                      }}
                  ...
                  <PrismicLink
                    ...
                    className="rounded-md px-3.5 py-2 text-sm font-semibold leading-6 text-darkGrey ring-1 ring-inset ring-darkGrey hover:ring-highlight focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-highlight"
                  >
