...
/**
 * Props for `HightlightedText`.
 */
export type HightlightedTextProps =
  SliceComponentProps<Content.HightlightedTextSlice>;

/**
 * Component for "HightlightedText" Slices.
 */
const HightlightedText: FC<HightlightedTextProps> = ({ slice }) => {
  return (
    <section
      ...
      >
        ...
        <div className="flex flex-col gap-3">
          ...
          <PrismicRichText
            ...
            components={{
              paragraph: ({ children }) => (
                <p className="text-darkGrey">{children}</p>
              ),
            }}
          />
        </div>
